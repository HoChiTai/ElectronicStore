						...
						<div className="col-3">
							<div className="statistic-item">
								...
								<div className="heading">
									...
									<div className="count">{total_customer}</div>
								</div>
							</div>
						</div>
						<div className="col-3">
							<div className="statistic-item">
								...
								<div className="heading">
									...
									<div className="count">{total_employee}</div>
								</div>
							</div>
						</div>
						<div className="col-3">
					...
					<div className="statistic-chart">
						...
						<ul className="chart">
							...
							{revenues.map((revenue) => {
								const value = revenue.result === null ? 0 : revenue.result;
								const percent = (value / 15000) * 100;
								return (
									<li className="passed" style={{ '--percent': `${percent}%` }}>
